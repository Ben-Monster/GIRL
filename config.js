...
module.exports = {
    ...
    SESSION: process.env.GIRL_CODE === undefined ? '' : process.env.GIRL_CODE,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴀᴘᴀʀɴᴀ ᴍᴡᴏʟ ᴠ2 ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'APARNA MWOL V2 ' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '918281370025,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
